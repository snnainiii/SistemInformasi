        ...
        ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-danger">Rp. <?= number_format($totalbelanja); ?>,-</th>
                    </tr>
                </tfoot>
            </table>
            ...
            <form action="" method="post">
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea name="alamat_pengiriman" cols="30" rows="3" class="form-control"
    ...
    $(document).ready(function() {
        ...
        $("select[name=nama_ekspedisi]").on("change", function() {
            ...
            $.ajax({
                ...
                ata: 'ekspedisi=' + ekspedisi_terpilih + '&distrik=' + distrik_terpilih +
                    '&berat=' + $total_berat,
